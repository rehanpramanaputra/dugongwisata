        ...
        <div class="staff-header p-4 mb-4">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-end">
                    <img src="folderfoto/eji3.jpg" alt="Staff" style="max-height: 150px;">
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <tr class="booking-card" style="border-left-color: #28a745;">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="folderfoto/eji1.jpg" alt="User" class="rounded-circle me-2" width="32">
                                        Budi Santoso
                                    </div>
                                </td>
                                <td>Bali 3D2N</td>
                            ...
                            <tr class="booking-card" style="border-left-color: #ffc107;">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="folderfoto/eji3.jpg" alt="User" class="rounded-circle me-2" width="32">
                                        Ani Wijaya
                                    </div>
                                </td>
                            ...
                            <tr class="booking-card" style="border-left-color: #dc3545;">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="folderfoto/eji2.jpg" alt="User" class="rounded-circle me-2" width="32">
                                        Citra Dewi
                                    </div>
                                </td>
                                <td>Lombok 5D4N</td>
