                ...
                <div class="ms-3">
                    <div class="dropdown">
                        <button class="btn btn-light rounded-pill dropdown-toggle d-flex align-items-center" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown">
                            <img src="folderfoto/eji3.jpg" alt="User" class="rounded-circle me-2" width="32" height="32">
        ...
        <div class="profile-header p-4 mb-4">
            <div class="row align-items-center">
                ...
                <div class="col-md-4 text-end">
                    <img src="folderfoto/eji3.jpg" alt="Travel" style="max-height: 150px;">
                </div>
            </div>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="trip-card card h-100">
                            <img src="folderfoto/bali.jpg" class="trip-img card-img-top" alt="Bali">
                            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="trip-card card h-100">
                            <img src="folderfoto/yogyakarta1.webp" class="trip-img card-img-top" alt="Yogyakarta">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                ...
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3 p-3 bg-light rounded">
                            <img src="folderfoto/promo.jpg" alt="Promo" class="rounded me-3" width="80">
                            <div>
